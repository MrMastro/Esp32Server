...
export default class SettingController {
    constructor() {
        ...
        this.waitView = new WaitView($('#WaitViewContainer'));
        this.init();
    }
    ...
    async saveSettings() {
        ...
        // Converti il valore esadecimale in un valore RGB
        const rgb = { r, g, b };
        ...
        if (success) {
            ...
            alert("Impostazioni salvate, il dispositivo sarà riavviato");
        } else {
    ...
    async showModal() {
        if (this.settingService.isLogged()) {
            this.settingView.render(this.settingService.getSettings());
