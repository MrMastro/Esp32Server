...
export default class SettingView {
    ...
    render(settings, esp32Model) {
                        ...
                        <div id="Settings-Card-Leds" class="card" style="margin-top: 10px;margin-bottom: 10px;min-width: initial;max-width: initial;">
                            ...
                            <div class="card-body" style="margin-top: 5px;margin-bottom: 5px;">
                                ...
                                <div id="Settings-Panel-InitialEffects" class="border rounded-0 d-flex flex-column visible" style="margin-top: 10px;margin-bottom: 10px;">
                                    ...
                                    <div id="Settings1-3" class="d-lg-flex d-xl-flex flex-column justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center ContainAction">
                                        <div id="settingTitleColor" class="container containerLabel" style="height: auto;max-height: 25px;"><label class="form-label text-center form-label-title" style="font-size: 12px;text-align: left;min-width: 90px;"> Colore Iniziale</label></div>
                                        <div class="text-center d-lg-flex d-xl-flex flex-row justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center containerOfComponent">
        ...
        if(typeof settings != "undefined"){
            document.querySelector("#settingTitleColor").textContent = Array.isArray(settings.initialColors) && settings.initialColors.length > 1?"Colori iniziali":"Colore iniziale";
        }
        ...
        if (settings) {
            ...
            this.groupColorSettingView.render(settings.initialColors, true, false);
