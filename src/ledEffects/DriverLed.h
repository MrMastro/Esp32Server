...
class DriverLed{
    public:
        DriverLed();
        DriverLed(NeoPixelBus<NeoGrbFeature, Neo800KbpsMethod> *ws2811Matrix, NeoPixelBus<NeoBrgFeature, Neo800KbpsMethod> *ws2811Strip, LEDStripDriver *rgbStrip);
