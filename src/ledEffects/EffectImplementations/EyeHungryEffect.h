#ifndef EYE_HUNGRY_EFFECT_H
#define EYE_HUNGRY_EFFECT_H

#include "../Effect.h"
#include <Arduino.h>

class EyeHungryEffect : public Effect
{
public:
    EyeHungryEffect();
    ...
    void displayLedMatrix(std::vector<std::vector<RgbColor>>& matrix, int rows, int cols,int offset, DriverLed *driver, TYPE_STRIP type);
